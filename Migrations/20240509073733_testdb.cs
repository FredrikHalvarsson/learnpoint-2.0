        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassCourses_Courses_FKCourseId",
                        column: x => x.FKCourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassCourses_SchoolClasses_FKSchoolClassId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Grades", x => x.StudentGradeId);
                    table.ForeignKey(
                        name: "FK_Grades_Courses_FkCourseId",
                        column: x => x.FkCourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassCourses_FKCourseId",
                table: "ClassCourses",
                column: "FKCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassCourses_FKSchoolClassId",
                table: "ClassCourses",
